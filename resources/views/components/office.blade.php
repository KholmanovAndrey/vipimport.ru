...
@if(Auth::user()->hasRole('superAdmin'))
    <ul class="{{ $css }}">
        ...
        {{--</li>--}}
        <li class="{{ $css }}__list">
            <a href="{{ route('address.index') }}" class="{{ $css }}__link d-flex justify-content-between">Адреса клиентов</a>
        </li>
        <li class="{{ $css }}__list">
...
@if(Auth::user()->hasRole('client'))
    <ul class="{{ $css }}">
        <li class="{{ $css }}__list"><a href="{{ route('address.my') }}" class="{{ $css }}__link d-flex justify-content-between">Адреса доставки</a></li>
